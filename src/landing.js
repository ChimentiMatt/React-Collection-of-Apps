...
export default function Landing() {
  ...
  document.addEventListener("keydown", function (event) {
    ...
    if (counter === 1040){
      ...
      gsap.to(
        "#cata1, #cata2, #cata3, #cata4, #cata5, #cata6, #cata7, #cataHead, #eye",
        { x: counter }
      );
      gsap.to(
        "#cata1, #cata2, #cata3, #cata4, #cata5, #cata6, #cata7, #cataHead, #eye",
    ...
    } else if (event.code === "Space" && reset === false) {
      gsap.to("#cata1", { y: -5 });
      gsap.to("#cata2", { y: -20 });
      gsap.to("#cata3", { y: -25 });
      gsap.to("#cata4", { y: -30 });
  ...
  function AnimateRC() {
    if (RCAnimated === true)    {
      ...
      tl.to("#landing-h1", { opacity: 0, direction: 0 })
        ...
        .to("#landing-line2", { delay: 0.5, opacity: 1 })
        .to("#landing-line3", { delay: 0.5, opacity: 1 })
        .to("#landing-line4", { delay: 0.5, opacity: 1 })
        .to("#landing-line1, #landing-line2, #landing-line3, #landing-line4", {
          delay: 0.5,
          opacity: 0,
        })
  ...
  return (
    <>
      ...
      <div id="landing-left">
        ...
        <p id="landing-line2">Animations </p>
        <p id="landing-line3">Games</p>
        <p id="landing-line4">Learning</p>
      </div>
      ...
      <div id="landing-right">
        ...
        <div id="pressAnyKey">
          <p>Press the 'space' Key to help the caterpillar get to the leaf</p>
        </div>
